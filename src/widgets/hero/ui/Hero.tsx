...
export function Hero() {
  ...
  const codeLines = [
    ...
    {
      text: '  domain: "raven.kr",',
      type: "property",
      delay: 0,
      hasString: true,
    },
    {
      text: '  spirit: "Soaring through code"',
      type: "property",
      delay: 0,
      hasString: true,
    },
      ...
      <div className="flex flex-col lg:flex-row items-center gap-12 w-full">
        <div className="flex-1 max-w-2xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            <span className="text-gradient">Raven Developer</span>
            <br />
          ...
          <p className="text-lg sm:text-xl text-text-secondary mb-8 leading-relaxed">
            까마귀가 디지털 하늘을 탐험하듯, 우아한 솔루션을 만들고 강력한 애플리케이션을
            구축합니다. React, TypeScript, 그리고 현대적인 웹 기술에 특화되어 있습니다.
          </p>
          ...
          <div className="glass p-8 rounded-2xl raven-shadow code-editor relative">
                      ...
                      <>
                        <span
                          dangerouslySetInnerHTML={{
                            __html: line.text.replace('"' + dynamicSkill + '",', ""),
                          }}
                        />
                        "
                        <span className={`dynamic-skill ${isTyping ? "typing" : ""}`}>
                          {dynamicSkill}
                        </span>
                        ",
                      </>
            ...
            <div className="mt-4 pt-4 border-t border-border">
              <div className="text-xs text-text-muted">
                <span className="text-accent">●</span> 다음 프로젝트를 함께 만들어갈 준비가
                되었습니다
              </div>
            </div>
          </div>
