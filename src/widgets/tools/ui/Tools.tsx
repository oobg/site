  ...
  return (
    <section id="tools" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <h2 className="text-4xl sm:text-5xl font-bold mb-4 text-gradient">Raven 도구들</h2>
        <p className="text-lg sm:text-xl text-text-secondary max-w-3xl mx-auto">
          개발 워크플로우를 간소화하고 생산성을 향상시키기 위해 까마귀의 지혜로 만든 도구들입니다.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {tools.map((tool, index) => (
          ...
          >
            ...
            <div className="absolute top-4 right-4">
              <span
                className={`px-3 py-1 text-xs font-semibold rounded-full ${
                  tool.status === "Ready" ? "bg-green-500 text-white" : "bg-blue-500 text-white"
                }`}
              >
            ...
            {/* Tool Description */}
            <p className="text-text-secondary mb-6 leading-relaxed text-sm">{tool.description}</p>
