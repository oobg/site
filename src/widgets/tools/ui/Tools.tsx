    ...
    <section id="tools" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {tools.map((tool, index) => (
          <div 
            key={index} 
            className="group relative bg-background-secondary border border-border rounded-2xl p-8 text-center hover:-translate-y-4 hover:shadow-2xl transition-all duration-500 raven-shadow overflow-hidden"
          >
            {/* Status Badge */}
