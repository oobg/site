    ...
    <section id="portfolio" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <p className="text-lg sm:text-xl text-text-secondary max-w-3xl mx-auto">
          Like a raven collecting treasures, here are some of my finest works.
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <div key={index} className="bg-background-secondary border border-border rounded-2xl p-8 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 raven-shadow">
