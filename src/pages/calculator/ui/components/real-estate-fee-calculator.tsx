  ...
  const result = useMemo(() => {
    ...
    if (type === 'sale') {
      ...
      if (price <= 50000000) {
        ...
        fee = 50000000 * 0.006 + 150000000 * 0.005 + (price - 200000000) * 0.004; // 0.4%
      } else if (price <= 900000000) {
        fee = 50000000 * 0.006 + 150000000 * 0.005 + 400000000 * 0.004 + (price - 600000000) * 0.005; // 0.5%
      } else {
        fee = 50000000 * 0.006 + 150000000 * 0.005 + 400000000 * 0.004 + 300000000 * 0.005 + (price - 900000000) * 0.009; // 0.9%
      }
    } else {
      // 전세 중개수수료
      if (price <= 50000000) {
        ...
        fee = 50000000 * 0.005 + 150000000 * 0.004 + (price - 200000000) * 0.003; // 0.3%
      } else if (price <= 900000000) {
        fee = 50000000 * 0.005 + 150000000 * 0.004 + 400000000 * 0.003 + (price - 600000000) * 0.004; // 0.4%
      } else {
        fee = 50000000 * 0.005 + 150000000 * 0.004 + 400000000 * 0.003 + 300000000 * 0.004 + (price - 900000000) * 0.005; // 0.5%
      }
    }
