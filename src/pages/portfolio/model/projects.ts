...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "실시간 데이터 시각화 대시보드. 복잡한 데이터를 직관적인 차트와 그래프로 표현합니다.",
  ...
  },
  {
    title: "Raven Chat",
    description:
      "실시간 채팅 애플리케이션. WebSocket을 활용한 즉시 메시지 전송과 파일 공유 기능을 제공합니다.",
  ...
  },
  {
    ...
    description:
      "팀 협업을 위한 프로젝트 관리 도구. 작업 할당, 진행 상황 추적, 실시간 알림을 지원합니다.",
...
export const getStatusColor = (status: string) => {
  return status === "Live" ? "bg-green-500 text-white" : "bg-blue-500 text-white";
};
