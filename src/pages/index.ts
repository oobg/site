/**
 * 페이지 lazy 컴포넌트 배럴.
 * 라우터는 여기서만 페이지를 불러와 코드 스플리팅을 유지한다.
 */
...
export { NotFoundPageLazy } from "./not-found";
export { ProjectDetailPageLazy } from "./project-detail";
export { ProjectsPageLazy } from "./projects";
